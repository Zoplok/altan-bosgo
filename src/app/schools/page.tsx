        ...
        <div className="bg-white dark:bg-navy-900 rounded-2xl border border-gray-200 dark:border-navy-800 p-5 shadow-sm mb-8 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-gray-100 dark:border-navy-800 text-xs">
            <span className="font-semibold text-gray-500 dark:text-gray-400 mr-1 flex items-center gap-1">
              <Filter className="w-3.5 h-3.5" /> Төрөл:
            </span>
            {[
              { id: 'all', label: 'Бүгд' },
            ...
            <span className="font-semibold text-gray-500 dark:text-gray-400 ml-3 mr-1">Ангилал:</span>
            ...
            >
              <div>
                <div className="relative h-48 w-full bg-gray-100 dark:bg-navy-800">
                  ...
                  <div className="absolute top-3 left-3 flex gap-1.5">
                    ...
                    <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-white/90 dark:bg-navy-800/90 text-navy-900 dark:text-gray-200 backdrop-blur">
                      {school.levels.join(', ')}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-5">
                  ...
                  <div className="space-y-1.5 pt-3 border-t border-gray-100 dark:border-navy-800 text-xs text-gray-600 dark:text-gray-300">
              ...
              <div className="p-5 pt-0">
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-gray-50 dark:bg-navy-800 hover:bg-gold hover:text-navy-900 text-navy-900 dark:text-white text-xs font-bold transition-all shadow-sm flex items-center justify-center gap-1.5"
                >
            ...
            <div className="bg-white dark:bg-navy-900 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 sm:p-8 shadow-2xl border border-gold/30">
              <div className="flex items-start justify-between gap-4 mb-4">
                ...
                <button
                  ...
                  className="p-1 text-gray-400 hover:text-navy-900 dark:hover:text-white text-lg font-bold"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <div className="p-4 bg-surface-light-subtle dark:bg-navy-950 rounded-2xl border border-gray-100 dark:border-navy-800">
                  ...
                  <ul className="space-y-2 text-xs text-gray-600 dark:text-gray-300">
                    {selectedSchoolModal.announcements.map((ann: any, i: number) => (
                      <li key={i} className="flex items-center justify-between gap-2">
                        <span>• {ann.title}</span>
                        <span className="text-gray-400 shrink-0">{ann.date}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 dark:border-navy-800 flex justify-end">
                <button
                  onClick={() => setSelectedSchoolModal(null)}
                  className="px-5 py-2 rounded-xl bg-navy-900 text-white dark:bg-gold dark:text-navy-900 text-xs font-bold"
                >
                  Хаах
                </button>
              </div>
